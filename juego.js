...
var Juego = {
    ...
    create: function () {
        ...
        timer = juego.time.events.loop(1500, this.crearColumnas, this);

        puntos = -1;

        txtPuntos = juego.add.text(20, 20, "0", {font:"30px Arial",
    fill: "#FFF"});
    ...
    update: function(){
        ...
        {
            //Reiniciar el juego = enviar a Game_Over
        ...
        juego.physics.arcade.overlap(flappy, tubos,
            this.tocoTubo, null, this);
        //bg.tilePosition.x -= 1;
